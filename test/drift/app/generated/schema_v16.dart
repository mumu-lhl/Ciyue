...
class OpenRecords extends Table with TableInfo<OpenRecords, OpenRecordsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  OpenRecords(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
      hasAutoIncrement: true,
      type: DriftSqlType.int,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  OpenRecordsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class OpenRecordsData extends DataClass implements Insertable<OpenRecordsData> {
  ...
  factory OpenRecordsData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return OpenRecordsData(
      id: serializer.fromJson<int>(json['id']),
  ...
  OpenRecordsData copyWithCompanion(OpenRecordsCompanion data) {
    return OpenRecordsData(
      id: data.id.present ? data.id.value : this.id,
      word: data.word.present ? data.word.value : this.word,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
  ...
  @override
  String toString() {
    return (StringBuffer('OpenRecordsData(')
          ..write('id: $id, ')
          ..write('word: $word, ')
          ..write('createdAt: $createdAt')
          ..write(')'))
