...
class HunspellSource extends Table
    with TableInfo<HunspellSource, HunspellSourceData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  HunspellSource(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> affPath = GeneratedColumn<String>(
    'aff_path',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> dicPath = GeneratedColumn<String>(
    'dic_path',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<int> twoPassLookup = GeneratedColumn<int>(
    'two_pass_lookup',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (two_pass_lookup IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  @override
  List<GeneratedColumn> get $columns => [
  ...
  @override
  HunspellSource createAlias(String alias) {
    return HunspellSource(attachedDatabase, alias);
  }
...
class HunspellSourceData extends DataClass
    implements Insertable<HunspellSourceData> {
  final int id;
  final String name;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['aff_path'] = Variable<String>(affPath);
    map['dic_path'] = Variable<String>(dicPath);
    if (!nullToAbsent || language != null) {
      map['language'] = Variable<String>(language);
    }
    map['enabled'] = Variable<int>(enabled);
    map['order'] = Variable<int>(order);
    map['two_pass_lookup'] = Variable<int>(twoPassLookup);
    return map;
  }
  ...
  factory HunspellSourceData.fromJson(
    ...
    return HunspellSourceData(
      ...
      order: serializer.fromJson<int>(json['order']),
      twoPassLookup: serializer.fromJson<int>(json['twoPassLookup']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'order': serializer.toJson<int>(order),
      'twoPassLookup': serializer.toJson<int>(twoPassLookup),
    };
  }
...
class HunspellSourceCompanion extends UpdateCompanion<HunspellSourceData> {
  final Value<int> id;
  final Value<String> name;
  final Value<String> affPath;
  final Value<String> dicPath;
  final Value<String?> language;
  final Value<int> enabled;
  final Value<int> order;
  final Value<int> twoPassLookup;
  const HunspellSourceCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
    this.affPath = const Value.absent(),
    this.dicPath = const Value.absent(),
    this.language = const Value.absent(),
    this.enabled = const Value.absent(),
    this.order = const Value.absent(),
    this.twoPassLookup = const Value.absent(),
  });
  HunspellSourceCompanion.insert({
    ...
    this.twoPassLookup = const Value.absent(),
       ...
       affPath = Value(affPath),
       dicPath = Value(dicPath);
  static Insertable<HunspellSourceData> custom({
    Expression<int>? id,
    Expression<String>? name,
    Expression<String>? affPath,
    Expression<String>? dicPath,
    Expression<String>? language,
    Expression<int>? enabled,
    Expression<int>? order,
    Expression<int>? twoPassLookup,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
  ...
  HunspellSourceCompanion copyWith({
    Value<int>? id,
    Value<String>? name,
    Value<String>? affPath,
    Value<String>? dicPath,
    Value<String?>? language,
    Value<int>? enabled,
    Value<int>? order,
    Value<int>? twoPassLookup,
  }) {
    return HunspellSourceCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (affPath.present) {
      map['aff_path'] = Variable<String>(affPath.value);
    }
    if (dicPath.present) {
      map['dic_path'] = Variable<String>(dicPath.value);
    }
    if (language.present) {
    ...
    if (twoPassLookup.present) {
      map['two_pass_lookup'] = Variable<int>(twoPassLookup.value);
    }
    return map;
  }
...
class OpenRecordsData extends DataClass implements Insertable<OpenRecordsData> {
  ...
  factory OpenRecordsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class FlashcardReviewLogsData extends DataClass
  ...
  factory FlashcardReviewLogsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class DatabaseAtV19 extends GeneratedDatabase {
  ...
  late final HunspellSource hunspellSource = HunspellSource(this);
  ...
  late final Index idxOpenRecords = Index(
    'idx_open_records',
    'CREATE INDEX idx_open_records ON open_records (word, created_at)',
  );
  late final Index idxFlashcardsDue = Index(
    'idx_flashcards_due',
